    ...
    do ic=xstart(3),xend(3)
        ...
        do jc=xstart(2),xend(2)
            ...
            do kc=1,nxm
                ...
                vx(kc,jc,ic)=vx(kc,jc,ic)-(locdph-dphhalo(km,jc,ic))*usukm
                vy(kc,jc,ic)=vy(kc,jc,ic)-(locdph-dphhalo(kc,jm,ic))*udy
                vz(kc,jc,ic)=vz(kc,jc,ic)-(locdph-dphhalo(kc,jc,im))*udz
