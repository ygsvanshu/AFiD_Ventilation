...
!    CONTAINS: subroutines Mkmov_zcut and Mkmov_ycut      !
!                                                         ! 
!    PURPOSE: Write down zcut and ycut snapshot           ! 
!             for flow vars                               !
!                                                         !
!    CREATED BY: Chris Howland (c.j.howland@utwente.nl)   !
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

! =ModV24=Vanshu=2022-08-19=====================================================
...
subroutine Mkmov_zcut
    ...
    if (ic.le.xend(3) .and. ic.ge.xstart(3)) then
        ...
        if (fexist) then
            ...
            call h5gclose_f(group_id, hdf_error)
            call h5gcreate_f(file_id, "pr", group_id, hdf_error)
            call h5gclose_f(group_id, hdf_error)
        end if
...
subroutine Mkmov_outlet
        ...
        if (ic.le.xend(3)+lvlhalo .and. ic.ge.xstart(3)-lvlhalo) then
