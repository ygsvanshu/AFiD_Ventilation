...
subroutine CreateGrid
    ...
    ! ================================================================
    ! UNIFORM GRID CREATION FOR HORIZONTAL DIRECTIONS
    ! ================================================================
    ...
    ! Coefficients for double derivatives in uniform horizontal directions
    ap2gj = dyq
    ac2gj = -2.0d0*dyq
    am2gj = dyq
    ...
    ! ================================================================
    ! STRETCHED GRID CREATION IN VERTICAL DIRECTION
    ! ================================================================
    ...
    ! OPTION 7: ERROR FUNCTION FOR VALIDATION OF PURE COUETTE FLOW WITH 
    ! S. PIROZZOLI et.al. "TURBULENCE STATISTICS IN COUETTE FLOW AT HIGH REYNOLDS NUMBERS" (2014)
    ...
    ! ================================================================
    ! METRICS FOR UNIFORM DIRECTIONS
    ! ================================================================
    ...
    ! ================================================================
    ! COEFFICIENTS FOR ONE SIDED 2nd ORDER DIFFERENTIATION AT TOP AND BOTTOM BOUNDARIES
    ! ================================================================
    ...
    ! ================================================================
    ! COEFFICIENTS FOR ONE 2nd ORDER CENTRAL DIFFERENCE IN WALL NORMAL DIRECTION (FOR POST PROCESSING)
    ! ================================================================
    ...
    ! ================================================================
    ! COEFFICIENTS FOR ONE SIDED 2nd ORDER DIFFERENTIATION AT FIRST AND LAST GRID POINT
    ! ================================================================
