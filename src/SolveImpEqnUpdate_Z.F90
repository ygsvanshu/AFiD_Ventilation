    ...
    do ic=xstart(3),xend(3)
        do jc=xstart(2),xend(2)
            ...
            do kc=1,nxm
                ...
                ackl_b   = 1.0d0/(1.0d0-ac3sk(kc)*betadx*outvscz(kc,ic))
                amkl(kc) = -am3sk(kc)*betadx*outvscz(kc,ic)*ackl_b*(1.0d0-ibmz)
                ackl(kc) = 1.0d0
                apkl(kc) = -ap3sk(kc)*betadx*outvscz(kc,ic)*ackl_b*(1.0d0-ibmz)
