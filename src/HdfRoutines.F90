...
subroutine HdfWriteReal3D(filename,qua)
    ...
    integer :: comm,info
    integer :: ndims
    real,intent(in),dimension(1:nx,xstart(2):xend(2),xstart(3):xend(3)) :: qua
    character*50,intent(in) :: filename
...
subroutine HdfReadReal3D(filename,qua,st2,en2,st3,en3,n1o,n2o,n3o)
    ...
    real,intent(out),dimension(1:n1o,st2:en2,st3:en3) :: qua
    integer :: hdf_error
    integer(HID_T) :: file_id
    integer(HID_T) :: slabspace
    integer(HID_T) :: memspace
