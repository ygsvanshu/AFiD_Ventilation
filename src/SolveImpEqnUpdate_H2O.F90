!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!                                                         ! 
!    FILE: SolveImpEqnUpdate_H2O.F90                      !
!    CONTAINS: subroutine SolveImpEqnUpdate_H2O           !
!                                                         ! 
!    PURPOSE: Inverts the implicit equation for           !
!    water vapour, and updates it to time t+dt            !
!                                                         !
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do ic=xstart(3),xend(3)
        do jc=xstart(2),xend(2)
            ...
            do kc=1,nx
                ...
                rx1d(kc) = rhs(kc,jc,ic)*ackl_b*(1.0d0-ibmx) - h2o(kc,jc,ic)*ibmx
            enddo
