...
#if !defined(MPI3)
    call MPI_Alltoallw(src,decomp%zcnts_xzr,decomp%zdispls_xzr,decomp%ztypes_xzr, &
      dst,decomp%xcnts_xzr,decomp%xdispls_xzr,decomp%xtypes_xzr,MPI_COMM_WORLD,ierror)
#endif

#ifdef MPI3
    call MPI_Neighbor_alltoallw( &
      src,decomp%zcnts_xzr(decomp%zranks),decomp%zdispls_xzr(decomp%zranks),decomp%ztypes_xzr(decomp%zranks), &
      dst,decomp%xcnts_xzr(decomp%xranks),decomp%xdispls_xzr(decomp%xranks),decomp%xtypes_xzr(decomp%xranks), &
      decomp%ztoxNeighborComm,ierror)
#endif
